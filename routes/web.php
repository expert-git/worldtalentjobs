...
Route::get('loadMoreMessages', 'myController@loadMoreMessages');
Route::get('blockConv', 'myController@blockConv');
...
Route::group(['prefix' => 'employer','middleware' => ['logEmployer','logGuest']], function () {
          ...
          /*Bradly change*/
          Route::get('/checkout/{emp}','billingController@empcheckout');
          Route::post('/checkout','billingController@postempcheckout');
          Route::get('/callback','billingController@getEmployerCallback');
          Route::get('/success','billingController@getSuccess');
          Route::get('/failed/{emp}','billingController@getFailed');
          Route::get('/searchpage','billingController@getSearchPage');
          Route::get('/paypal','PaypalPaymentController@paywithCreditCard');
          Route::get('/status','billingController@getPaypalEmployerCallback');
          Route::get('/jbsdeatil/{id}','billingController@getjbsdetails');
          Route::get('/failed/',function (){
              return redirect(url('/employer/failed/1'));
          });
          Route::get('/jobneeded','billingController@getJobNeeded');
          /*End Bradly change*/
          ...
          Route::get('removeimage','employerController@removeimage');
          ...
          Route::get('/waitforapproval', function(){
            return view('employer.auth.waitforapproval');
          });
});
Route::get('/contactus', 'myController@contactus');
Route::get('/about', 'myController@about');
Route::get('/termsofuse', 'myController@termsOfUse');
Route::get('/privacypolicy', 'myController@privacyPolicy');
Route::get('/cookiespolicy', 'myController@cookiesPolicy');
...
Route::group(['prefix' => 'jobseeker'], function () {
         ...
         //bradly change
        Route::get('/searchpage','billingController@getSearchPage');
        Route::get('/checkout','billingController@jbsCheckout');
         Route::post('/checkout','billingController@postJbsCheckout');
         Route::get('/callback','billingController@getJobseekerCallback');
         Route::get('/success','billingController@getSuccess');
         Route::get('/failed/{emp}','billingController@getFailed');
         Route::get('/jobneeded','billingController@getJobNeeded');
         Route::get('/status','billingController@getPaypalJobseekerCallback');
         Route::get('/jbsdeatil/{id}','billingController@getjbsdetails');
        ...
        // Route::get('/','alljobsController@index')->name('jshome');
          ...
          Route::get('/applydirectly/{id}','alljobsController@applywithoutquestions');
...
Route::group(['prefix' => 'inspector'], function () {
           ...
           // Route::get('/jobposts/{emp}','Inspector\EmployerController@getJobposts');
            ...
            Route::post('/jbs/editresume/postupdatetargetjob','Inspector\employerController@updateTargetJob');
            Route::post('/jbs/editresume/updateEducation', 'Inspector\employerController@updateEducations');
            ...
            Route::get('/jobseekerlist/{sdate}/{ndate}','Inspector\employerController@datejobseekerlist');//dashboard category list page
            Route::get('/notifications','Inspector\employerController@getNotifications');
            ...
            Route::get('employerlist/{sdate}/{ndate}','Inspector\employerController@dateemployerlist');//dashboard category list page
            ...
            Route::get('/deleteadmins/{id}','Inspector\employerController@getdeleteadmins');
            Route::get('/joblist/{sdate}/{ndate}','Inspector\employerController@postjoblist');
            Route::get('/removeEducation', 'Inspector\employerController@removeEducation');
            Route::post('/jbs/editresume/updateExperience', 'Inspector\employerController@updateWorkexperience');
            Route::get('/removeExperience', 'Inspector\employerController@removeExperience');
            Route::post('/jbs/editresume/updateSkillset', 'Inspector\employerController@updateSkillset');
            Route::get('/removeSkillset', 'Inspector\employerController@removeSkillset');
            Route::post('/jbs/editresume/updateProfileExp', 'Inspector\employerController@updateProfileExp');
            Route::post('/addcv', 'Inspector\employerController@addcv');
            Route::get('/jbs/editresume/updateProfile', 'Inspector\employerController@updateProfile');
            Route::get('/removecv', 'Inspector\employerController@removecv');
            Route::post('/addcertfile','Inspector\employerController@edu_certfile_add');
            Route::get('removecertfile','Inspector\employerController@edu_certfile_remove');


            Route::get('/empty','Inspector\employerController@testmodule');
...
//email verification
Route::get('/appliedJobMail/{id}/{jsid}','jobController@appliedJobMail')->name('appliedJobMail');
Route::get('sendVerifymail/{email}/{token}','JobseekerAuth\RegisterController@SendMailDone')->name('SendMailDone');
Route::get('sendEVerifymail/{email}/{token}','EmployerAuth\RegisterController@sendEVerifymail')->name('sendEVerifymail');
Route::get('sendEMailDone/{email}/{token}','EmployerAuth\RegisterController@sendEMailDone')->name('sendEMailDone');
Route::get('employerApproveEmail/{emp}','Inspector\employerController@employerApproveEmail')->name('employerApproveEmail');
Route::get('sendEVerifymailForChange/{email}/{new_email}/{token}','myController@sendEVerifymailForChange')->name('sendEVerifymailForChange');
