...
@section('content')
	...
	<div class="wrapper" style="margin:15px 0 0 15px;">
		<div class="container">
			<div class="row">
			<div class="col-xs-12">   
		...
		<div class="row content-wrapper">
			...
			<div class="btn-group col-sm-6">
				...
				<ul class="pagination">
				<li>
				<form class="pagination-selector" style="display: inline-block;">
				<p><span class="pagination-page-title">Page</span>
				<input class="input-pagination" size="1" name="page" data-link="/en/jobs/?by=&in=&" value="1" type="text">
				<span class="pagination-page-number">
				of
				<strong>83</strong>
				</span>
				<a class="btn btn-pagination" href="/en/jobs/?by=&in=&page=2">
				<i class="fa fa-angle-right" aria-hidden="true"></i>
				</a>
				<a class="btn btn-pagination" href="/en/jobs/?by=&in=&page=83">
 ...
 --}}
      ...
      @elseif(isset($searchQuery) && count($searchQuery)>0)
