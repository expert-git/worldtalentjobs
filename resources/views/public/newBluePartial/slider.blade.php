		...
		<div class="bg-success mar-pad">
			...
			<div class="row">
				<div class="col-md-6 col-sm-12 col-lg-6">
					<a href="search?location[] =2" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Dhaka</a>
					<a href="search?location[] =3" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Barisa</a>
					<a href="search?location[] =4" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Khulna</a>
					<a href="search?location[] =6" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Chittagong</a>
				</div>
				<div class="col-md-6 col-sm-12 col-lg-6">
					<a href="search?location[] =5" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Sylhet</a>


					<form action="search" id="searchable">
						<input type="button" value="1" class="submit">
					</form>
					
					<a href="search?location[] =1" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Rajshahi </a>
					<a href="search?location[] =" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Rangpur </a>
					<a href="search?location[] =" class="btn btn-primary btn-size b-x" target="_blank" name="location[]" >Mymensingh</a>
				</div>
			</div>
