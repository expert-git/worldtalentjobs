...
@section('content')
                        ...
                        <div class="col-md-3">
                            <div class="row">
                                ...
                                @if(file_exists($jobs[0]->profile_img))	
                                    <img src="/{{$jobs[0]->profile_img}}" style=" margin-left: auto; margin-right: auto; width:196px; height:196px;" id="profimg" data-chk="1">
                                @else
                                    <img src="/img/profile.png" style=" margin-left: auto; margin-right: auto; width:196px; height:196px;" id="profimg" data-chk="0">
                                @endif
                            </div>

                            <div class="row" style="margin-top:2%">
                                <div style=" margin-left: auto; margin-right: auto; width:196px;">
                                    <span type="submit" class="btn-profileimage" style="float:right;position: relative;overflow: hidden;">
                                        Upload
                                        <input required type="file" id="avatar" accept="image/png,image/jpeg" name="avatar"/>
                                    </span>
                                </div>
                            </div>
    ...
    <form method="POST" action="/jobseeker/updateProfileBasic" id="personal_detail_form">
        {{ csrf_field() }}
        <section>
            <div class="container">
                    ...
                    <div class='col-md-6'>
                        ...
                        <div class="form-group">
                            <div class='input-group date' id='jobseeker_dob_datetimepicker'>
                                <input required type='text' id="jobseeker_dob" name="jobseeker_dob" value="{{$jobs[0]->jobseeker_dob}}"
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input required class="ico-03" class="form-control" name="jobseeker_email"
                            value="{{Auth::guard('jobseeker')->user()->email}}" disabled type="text" id="jobseeker_email" placeholder="">
    ...
    <form method="POST" action="/jobseeker/updateTargetJob" id="personal_target_job">
        {{ csrf_field() }}
        ...
        <section>
            ...
            <div class="container">
                ...
                <div class="form-group">
                    ...
                    <textarea value="{{$jobs[0]->target_objective}}" name="target_objective" class="ico-03"
...
<script>
    ...
    function removeexppanel(id) {
        // send ajax get request
        $.ajax({
            url: "/jobseeker/removeExperience",
            data: {'exp_id':id},
            dataType: "json",
            success: function (res) {
