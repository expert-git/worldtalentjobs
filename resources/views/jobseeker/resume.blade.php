    ...
    <div style="margin-top:2%;width:90%;" class="container">
        <div class="row">
            ...
            <div style="" class="col-md-8" id="mainresumediv">
                <div id="resumebtns">
                <h4 class="Posthed col-md-2" style="padding:0px"><a href="/jobseeker/getProfile"> Settings</a> </h4>
                <h4 class="Posthed col-md-2"><a href="/jobseeker/myresume" style="color:#7889FF;">Resume</a></h4>
                <h4 class="Posthed col-md-6">
                    <a href='javascript:print1(1)' style="float:right;">
{{--                    <a href='/jobseeker/resumepdf' target="_blank" style="float:right;">--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-8" style="margin-bottom: 30px;">
                        ...
                        <div class="col-md-5 fw-900">
                            {{Auth::guard('jobseeker')->user()->email}}
                        </div>
...
<script>
  ...
  function print1() {
    ...
    html2canvas(resumediv, 
        ...
        pdf = new jsPDF('p', 'mm', [width*2.83, (height+30)*2.83], true);

        pdf.addImage(canvas.toDataURL('image/png'), 'PNG', 0, 15, width, height, '', 'FAST');
        pdf.save(filename);
    });
