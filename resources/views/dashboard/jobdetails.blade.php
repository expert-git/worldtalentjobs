    ...
    <section style="">
        ...
        <div class="row dashbord">
			<div class="col-md-9 col-sm-12">
			    ...
			    @foreach(explode(',',$job[0]->job_responsibilities) as $info) 
         <span class="border1">{{$info}}</span>
  @endforeach
				
				<div class="row">
					<div class="col-md-12">
					<p>{{$job[0]->educational_qualification}}</p></div>
				</div>
			</div>
			<div class="col-md-3 col-sm-12">
				<div class="action_buttons">
					<span class="edit_button"><a href="/inspector/editajob/{{$id}}">EDIT</a></span>
				...
				<div class="row" style="padding-top:10px;">
					...
					<div class="col-md-5 col-xs-5 text-right"> {{$job[0]->deadline}}</div>
					<div class="col-md-7 col-xs-7">Status</div> 
        ...
        <div class="col-md-3 col-sm-12 message_userlist">
                ...
                @foreach($applicants as $a)
					<li>
                    <a href="/inspector/postdetails/{{$id}}/{{$a->jobseeker_id}}">
                    <span class="logo1">
                        @if($a->jobseeker_id)
                        <img src="/jsimage/{{$a->jobseeker_id}}">
                        @else
...
<div class="row padding_row">
						<div class="col-md-offset-1 col-md-6 col-md-6 col-sm-12 top_contet2">
							...
							<p>{{$jobprofile->target_title}}<br /><b>{{$job[0]->companyname}}</b></p>
								
						</div>
						
						<div class="col-md-5 pull-right">
							<span class="message message2"> <i class="far fa-envelope"></i> <a href="javascript:window.print()">Print</a> </span>
							<span class="message message2"> <i class="far fa-envelope"></i> <a href="/inspector/message/{{$job[0]->employer_id}}"> Message</a> </span>
							@if(isset($applicants[0]))
                            <a href="/inspector/markspam/{{$applicants[0]->aj}}/4">
                            <span class="markspan markspan2">Mark as Spam 
                            </span></a>	
                            @endif				
						</div>
					</div>
