<div class="row dashbord">
    ...
    <div class="col-md-2 col-sm-12 text-right" onclick="printDiv('printjobdiv')">
        <div class="d-print-none" id="printjob"><img width="30px" height="30px" src="http://www.worldtalentjobs.com/img/print.png" alt=""> Print </div>
    </div>
                    ...
                    <div class="arrow_box" style="width:80px;height:60px;padding:5px;">
                        <div class="editicons23">
                            ...
                            <div style="font-size:12px;"><a href="/inspector/closestatus/{{$j->id}}"><img src="/img/delete.jpg"
                                                                                                         style="padding-top: 10px; padding-right: 10px; float: left;"> CLOSED</a></div>
                            <br clear="all" />
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12 text-center" style="padding:0 30px;">
                ...
                @else
                    <div class="notification_2 col-md-12">
                        <a href="/inspector/jobdetails/{{$myprofile->id}}/{{$j->id}}/0">
