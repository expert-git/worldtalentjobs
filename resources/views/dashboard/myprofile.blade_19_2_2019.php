...
<div class="row">
  <div class="col-md-3">
  <form method="POST" enctype="multipart/form-data" action="/inspector/updateProfileBasic">
...
<form method="POST" action="/inspector/updateProfileBasic">
 <div class="col-md-6">
 {{ csrf_field() }}
 ...
 <input name="full_name" class="ico-03" value="{{$jobs[0]->full_name}}" type="text" placeholder="Full Name">
 ...
 <input  class="form-check-input" type="radio" id="inlineCheckbox1" name="jobseeker_gender" checked  value="Male">Male
</div>
<div class="form-check form-check-inline">
 <input  class="form-check-input" type="radio" id="inlineCheckbox2" value="Female" @if($jobs[0]->jobseeker_gender=="female") checked @endif name="jobseeker_gender">Female
</div>
 ...
 <div class="form-check form-check-inline">
 <input class="form-check-input" type="radio" name="jobseeker_maritalstatus" id="inlineCheckbox1" checked value="Single">Single
</div>
<div class="form-check form-check-inline">
 <input class="form-check-input" type="radio" name="jobseeker_maritalstatus" id="inlineCheckbox2" @if($jobs[0]->jobseeker_maritalstatus=="married") checked @endif value="Married">Married
</div>
 ...
 <div class="form-row align-items-center">
   <div class="ico-03" class="col-auto my-1">
     ...
     <select name="jobseeker_nationality" value="{{$jobs[0]->jobseeker_nationality}}" class="ico-03 natidropdo custom-select mr-sm-2" id="inlineFormCustomSelect">
 ...
 <div class="form-row align-items-center">
   <div class="col-auto my-1">
     ...
     <select value="{{$jobs[0]->jobseeker_current_location}}" name="jobseeker_current_location" class="natidropdo custom-select mr-sm-2" id="inlineFormCustomSelect">
...
<div class="col-md-6">
 ...
 <input value="{{$jobs[0]->VISA_status}}" name="VISA_status" class="ico-03" class="form-control" type="text" placeholder="">
 ...
 <input value="{{$jobs[0]->Driving_Licence}}" name="Driving_Licence" class="ico-03" class="form-control" type="text" placeholder="">
 </div>
  </div>
...
<div class="col-md-6">
 ...
 <input name="Languages" value="{{$jobs[0]->Languages}}" class="ico-03" class="form-control" type="text" placeholder="">
 ...
 <input class="form-check-input" type="radio" name="NOC" @if($jobs[0]->NOC==1) checked @endif id="inlineCheckbox1" value="1">
 <label class="form-check-label" for="inlineCheckbox1">Available</label>
</div>
<div class="col-sm-12 col-md-6">
 <input class="form-check-input" type="radio" name="NOC"  @if($jobs[0]->NOC==0) checked @endif id="inlineCheckbox2" value="0">
...
<div class="col-md-6">
 ...
 <input class="ico-03" class="form-control" name="jobseeker_email" value="{{$jobs[0]->jobseeker_email}}" type="text" placeholder="">
...
<div class="col-md-6">
 ...
 <label>Mobile</label>
 <input class="ico-03" class="form-control" name="jobseeker_phone1" value="{{$jobs[0]->jobseeker_phone1}}" type="text" placeholder="">
...
<div class="form-group">
   ...
   <textarea name="target_tags" value="{{$jobs[0]->target_tags}}" class="ico-03" id="exampleFormControlTextarea1" rows="3">{{$jobs[0]->target_tags}}</textarea>
 </div>
...
<div class="form-group">
   ...
   <input name="target_title" value="{{$jobs[0]->target_title}}" type="test" class="ico-03" id="exampleFormControlInput1" placeholder="">
 </div>
...
<option value="{{$ind->id}}" @if($ind->id==$jobs[0]->target_location) selected @endif>{{$ind->name}}</option>
 ...
 <div class="form-group">
   ...
   <input name="target_salary" value="{{$jobs[0]->target_salary}}" type="test" class="ico-03" id="exampleFormControlInput1" placeholder="">
 </div>
</div>
</div>
...
<option value="{{$ind->id}}" @if($ind->id==$jobs[0]->target_industry) selected @endif>{{$ind->industrytypename}}</option>
 ...
 <div class="form-group">
   ...
   <select value="{{$jobs[0]->target_career_level}}" name="target_career_level" class="ico-03 natidropdo custom-select mr-sm-2" id="exampleFormControlSelect1">
...
<div class="form-group">
   ...
   <textarea value="{{$jobs[0]->target_objective}}" name="target_objective" class="ico-03" id="exampleFormControlTextarea1" rows="3">{{$jobs[0]->target_objective}}</textarea>
 </div>
...
<div class="form-group">
   ...
   <input type="text"  name="stream[]" value="{{$e->stream}}" class="ico-03" id="exampleFormControlInput1" placeholder="">
 </div></div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">Start Date</label>
      <div class='input-group date' id='datetimepicker1'>
                   <input type='date' name="sdate[]" value="{{$e->sdate}}" name="sdate" style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">End Date</label>
     <div class='input-group date' id='datetimepicker1'>
                   <input type='date' name="edate[]" value="{{$e->edate}}" name="edate" style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<input type="test" name="companyname[]" value="{{$e->companyname}}" required class="ico-03" id="exampleFormControlInput1" placeholder="">
</div>
</div>
<div class="col-md-6">
<div class="form-group">
   <label for="exampleFormControlInput1">Website</label>
      <div class='input-group date' id='datetimepicker1'>
                   <input type='text' value="{{$e->website}}" required name="website[]" style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<input type="test" name="location[]" value="{{$e->location}}" required class="ico-03" id="exampleFormControlInput1" placeholder="">
</div>
</div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">Start Date</label>
      <div class='input-group date' id='datetimepicker1'>
                   <input type='date' value="{{$e->sdate}}" required name="sdate[]" style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">End Date</label>
     <div class='input-group date' id='datetimepicker1'>
                   <input type='date' value="{{$e->edate}}" required name="edate[]" required style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<div class="form-group">
<label for="exampleFormControlInput1">Location</label>
<input type="test" name="location[]"  class="ico-03" id="exampleFormControlInput1" placeholder="">
</div>
</div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">End Date</label>
     <div class='input-group date' id='datetimepicker1'>
                   <input type='date'  name="edate[]"  style="    line-height: 50px;" class="ico-03" class="form-control" />
                   <span class="input-group-addon">
                       <span class="glyphicon glyphicon-calendar"></span>
                   </span>
               </div>
...
<div class="form-group">
   ...
   <input type="test" name="link1" value="{{$exp->link1}}" class="ico-03" id="exampleFormControlInput1" placeholder="">
 </div></div>
...
<div class="form-group">
   <label for="exampleFormControlInput1">URL</label>
   <input type="test" name="link2" value="{{$exp->link2}}" class="ico-03" id="exampleFormControlInput1" placeholder="">
 </div></div>
