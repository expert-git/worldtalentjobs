...
<script src="{{url('/js/js/vendor/jquery.ui.widget.js')}}/js/js/vendor/jquery.ui.widget.js"></script>

<script src="{{url('/js/js/jquery.iframe-transport.js')}}"></script>
...
<script>
    $(document).ready(function() {
        ...
        $("#employer_datatable_filter").remove();
        $("#postlist_filter").remove();
        $("#postlist_paginate").remove();
        $("#postlist_info").remove();
        $("#employer_datatable_paginate").remove();
        $("#employer_datatable_info").remove();
    });

</script>

<script src="{{url('/js/js/jquery.fileupload.js')}}"></script>
