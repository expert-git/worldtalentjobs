...
<form method="POST" id="education_form_{{$edu->id}}" action="/inspector/jbs/editresume/updateEducation" data-id="{{$edu->id}}">
    {{ csrf_field() }}
