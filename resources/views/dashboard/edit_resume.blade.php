    ...
    <div class="nav-header" >
        <nav>
            <ul class="top-nav detail">
                ...
                <li><a href="{{url('/inspector/jbs/jobs/'.$id)}}">Jobs</a></li>
                <li class="lastlicl"><a href="{{url('/inspector/emp/message/'.$id.'/0')}}">Messages</a></li>
            </ul>
        </nav>
    </div>
<div class="nav-in" style="width: 80%; margin-top: 20px;">
    ...
    <h3 class="bold">Personal Details</h3><br>
                ...
                <div class="row">
                    <div class='col-md-6'>
                        ...
                        <div class="form-group">
                            <div class='input-group date' id='jobseeker_dob_datetimepicker' style="    width: 100%;">
                                <input required class="databirth" type='text' id="jobseeker_dob" name="jobseeker_dob" value="{{$jobs[0]->jobseeker_dob}}"
            ...
            <div class="container" style="width: auto">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input required class="ico-03" class="form-control" name="jobseeker_email"
                               value="{{$jbsmain->email}}" disabled type="text" id="jobseeker_email" placeholder="">
                ...
                <div class="row">
                    <div class="col-md-12 " style="margin-top:15px">
                        <button class="profile-btn personal_info btnupdate" data-form-id="personal_detail_form"
    ...
    <form method="POST" action="{{url('/inspector/jbs/editresume/postupdatetargetkob')}}" id="personal_target_job">
        {{ csrf_field() }}
        <input type="hidden" name="id" value="{{$id}}">
            ...
            <div class="container" style="width: auto;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="margin-top:10px">
                        <button class="ico-03 profile-btn target_job btnupdate" data-form-id="personal_target_form" style="float:right"
    ...
    <section>
        <div class="container" style="width: auto">
            ...
            @include('jobseeker.education', ['edu' => $nedu, 'country' => $country])
            @foreach($edu as $e)
                @include('jobseeker.education', ['edu' => $e, 'country' => $country])
            @endforeach
        </div>
    </section>
    ...
    <section>
        <div class="container" style="width: auto">
            ...
            @include('jobseeker.experience', ['exp' => $nexp, 'country' => $country])
            @foreach($exp as $e)
                @include('jobseeker.experience', ['exp' => $e, 'country' => $country])
            @endforeach
            ...
            @include('jobseeker.skillset', ['skillset' => $nskill])
            @each('jobseeker.skillset', $skills, 'skillset')

            <form id="ex_link_form" method="POST" action="/jobseeker/updateProfileExp">
                {{ csrf_field() }}
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="websiteurl">
                                ...
                                <input type='text' value="{{$jobs[0]->ex_link1}}" name="ex_link1" id="ex_link1"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="websiteurl">
                                ...
                                <input type='text' value="{{$jobs[0]->ex_link2}}" name="ex_link2" id="ex_link2"/>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 " style="margin-top:15px">
                        <button class="profile-btn personal_info btnupdate" type="submit" id="personalexlinksubmit">UPDATE
                        </button>
                    </div>
                </div>
            </form>
    ...
    <form method="GET" id="alldata" action="/jobseeker/updateProfile">
        {{csrf_field()}}
        <section>
            <div class="container" style="margin-bottom:250px;width: auto">
                <div class="row" style="margin-top:50px">
                    <div class="col-md-8" style="margin-top:40px;">
                        <label>Please note: Any information you change in "My Account" will also be changed in your CV.</label>
                    </div>
                    <div class="col-md-4">
                        <button class="profile-btn submit btnupdate" id="allsubmit" data-form-id="alldata" >
                            SUBMIT
                        </button>
                    </div>
                </div>
...
@section('script')
    ...
    <script src="{{url('/js/bootstrap-tagsinput/bootstrap-tagsinput.min.js')}}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/typeahead.js/0.11.1/typeahead.bundle.min.js"></script>
    <!-- bootstrap tagsinput end -->
    <script type="text/javascript" src="{{url('/js/moment/moment.min.js')}}"></script>
    <script src="{{url('/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>

    <script src="{{url('/js/countrydiallist/js/intlTelInput.js')}}"></script>
