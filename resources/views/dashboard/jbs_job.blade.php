    ...
    <div class="nav-header" >
        <nav>
            <ul class="top-nav detail">
                <li ><a href="{{url('/inspector/jbs/getProfile/'.$jbsid)}}">Profile</a></li>
                <li class="activeul"><a href="{{url('/inspector/jbs/jobs/'.$jbsid)}}/0">Jobs</a></li>
                <li class="lastlicl"><a href="{{url('/inspector/jbs/message/'.$jbsid.'/0')}}">Messages</a></li>
            </ul>
        </nav>
    </div>
        ...
        <div style="margin-top:2%;width:90%;" class="container nav-in">
            <div class="row">
                ...
                <div style="" class="col-md-8">
                    <a href="{{url('/inspector/jbs/jobs/'.$jbsid)}}/0" style="@if($id==0) color:#7889FF; @endif font-size:18px;">
                        Jobs Applied ({{$applied}})
                    </a>
                    <a href="{{url('/inspector/jbs/jobs/'.$jbsid)}}/3" style="@if($id==3) color:#7889FF;@endif font-size:18px;margin-left:100px;">
