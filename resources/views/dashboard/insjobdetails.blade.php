...
@section('content')
        ...
        <div style="margin-top:2%;width:90%;" class="container">
            <div class="row">
                <div style="" class="col-md-10">
                    @include('dashboard.joboverview1', ['j' => $job, 'myprofile' => $myprofile])

                    <h4>Applicants</h4>
                    <div class="row">
                        <div class="col-md-3 col-sm-12 message_userlist">
                            @foreach($applicants as $a)
                                <a href="/inspector/jobdetails/{{$id}}/{{$a->jobseeker_id}}">
    ...
    <script>
        ...
        $('#rejectbtn').click( function () {
            window.location="/employer/changeCandidatestatus/{{$ajid}}/4";
        });
