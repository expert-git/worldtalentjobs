...
@section('content')
    <div class="container-fluid checkoutpage" style="min-height: 850px">
        <form method="post" action="{{url('/employer/checkout')}}">
            ...
            <div class="chktinfo col-md-7">
                ...
                <br>
                <div>
                    <img class="checkoutslideimage" src="{{url('/img/empcheckoutimage.png')}}" alt="Check out">
                </div>
                <div>
                    <h2 class="visibilityTexr">Get More Visibility for Your Job Posts!</h2>
                </div>
                <div>
                    <p>Just for QAR 10 per day get more visibility for your job posts!</p>
                </div>
                <div class="">
                ...
                <div class="chkmain">
                    ...
                    <div class="chkchosediv">
                        ...
                        <label class="rdcontainer chkdeftext">
                            ...
                            <span class="checkmark"></span>&nbsp;
                            <img style="height: 20px;" width="50" src="{{url('/img/paypal.png')}}" alt="Mobile">
                        </label>
                    </div>
