...
$( function() {
	...
	$(document).on('click','.change_applicant_status',function(){
		
		console.log($(this).find('.change_applicant_status'));
		return;
		if(confirm('Are you sure you want to change status??'))
		{
			var id 	= $(this).find('.change_applicant_status').attr('value');
			var url = $(this).find('.change_applicant_status').attr('url');
			console.log($(this).find('.change_applicant_status'));
			$.ajax({
				url:url,
				type: 'get',
